...
export default function ProductModels() {
    ...
    const getCategoryNames = (categoryIds?: number[]) => {
        ...
        return categories
            .filter((cat) => cat.id && categoryIds.includes(cat.id))
            .map((cat) => cat.name);
    };
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <CardDescription>
                                    Jami {pagination?.total || 0} ta mahsulot modeli
                                </CardDescription>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <TableRow key={model.id}>
                                                ...
                                                <TableCell>
                                                    <div className="flex flex-wrap gap-1">
                                                        {model.category_detail && model.category_detail?.map((cat) => (
                ...
                <DialogContent className="sm:max-w-[525px]">
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)}>
                            <DialogHeader>
                                <DialogTitle>
                                    {editingId ? 'Tahrirlash' : 'Yangi model qo\'shish'}
                                </DialogTitle>
                                <DialogDescription>
                                    Mahsulot modeli ma'lumotlarini kiriting
                                </DialogDescription>
                            </DialogHeader>
