...
export default function ModelTypes() {
    ...
    const isMutating =
        createModelType.isPending || updateModelType.isPending || deleteModelType.isPending;
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <CardDescription>
                                    Jami {pagination?.total || 0} ta model turi
                                </CardDescription>
                            </div>
                        </div>
                    </div>
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)}>
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Model turi ma'lumotlarini kiriting
                                </DialogDescription>
                            </DialogHeader>
